 ...
 * @author neilm
 */
@WebServlet(name = "employee_proc", urlPatterns = {"/employee_proc"})
public class employee_proc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean result = pbl.employeeLogin(e);
            if (result) {
                ...
                response.sendRedirect("employeeChangeOrders.jsp?msg=" + message);
            }
            else {
